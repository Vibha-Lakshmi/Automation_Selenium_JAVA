...
public class CorridorChrome {
	public static void main(String[] args) throws Exception {
		...
		//List<WebElement> allElements = driver.findElements(By.xpath("//div[@name='livelist5']//ul[@class='app-livelist-container clearfix list-group']")); 
		List<WebElement> element1 = driver.findElements(By.cssSelector("label.app-label ng-scope ng-isolate-scope[name='label14']"));
		//List<WebElement> element2 = driver.findElements(By.xpath("//div[@name='livelist5']//ul[@class='app-livelist-container clearfix list-group']")); 
		//List<WebElement> element3 = driver.findElements(By.xpath("//div[@name='livelist5']//ul[@class='app-livelist-container clearfix list-group']")); 
		int size_element = element1.size();
		System.out.println("size = "+size_element);
		//String lb1 = 
		//for (WebElement element: element1) {
		for(int i=0; i< size_element;i++) {
			//String label1 = element1
			//String label2 = element2.getText();
			//String label3 = element3.getText();
...
//		      New Year's Day : Jan 01, 2019
		...
		// PHONE BOOK
		WebElement conn4;
		conn4 = driver.findElement(By.xpath("//div[6]//div[1]//div[1]//div[1]//a[1]"));
		conn4.click();
		Thread.sleep(2000);
		conn4 = driver.findElement(By.xpath("//span[contains(text(),'Hyderabad')]"));
		conn4.click();
		Thread.sleep(2000);
		conn4 = driver.findElement(By.name("textSearch"));
		conn4.sendKeys("Vibha Gopi");
		//call function to take screenshot
		takeSnapShot(driver, "d://test.png") ;    
		conn4 = driver.findElement(By.name("labelEmployeeName"));
		System.out.println("******************");
		System.out.println("Name: "+conn4.getText());
		conn4 = driver.findElement(By.xpath("//span[contains(text(),'vibha.lakshmi@imaginea.com')]"));
		System.out.println("Email id: "+conn4.getText());
		//Thread.sleep(2000);
		conn4 = driver.findElement(By.xpath("//span[contains(text(),'Back To Apps')]"));
		conn4.click();
		Thread.sleep(2000);
		...
		//Logout
		WebElement conn6;
		conn6 = driver.findElement(By.linkText("LOGOUT"));
		conn6.click();
		Thread.sleep(2000);
		WebElement conn7;
		conn7 = driver.findElement(By.linkText("log out"));
		conn7.click();
		Thread.sleep(2000);
//		driver.quit();
