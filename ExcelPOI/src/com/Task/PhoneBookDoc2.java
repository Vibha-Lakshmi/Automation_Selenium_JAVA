...
public class PhoneBookDoc2 {
	...
	String safeName = WorkbookUtil.createSafeSheetName("[" + "Sheet_" + dtf.format(now) + "*?]");
	...
	/*
	 * public void writeExcelFunc(String fileName) throws Exception {
	 * 
	...
	void phoneBookSearchResult() throws InterruptedException, Exception {
		System.out.println("*******");
		System.out.println("Phone Book Search Result");
		...
		FileOutputStream fout = new FileOutputStream(".\\PrintData\\BloodGroup_" + blood_grp +"_"+date+ ".txt");
